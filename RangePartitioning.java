...
//    DefaultTableModel model;
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    RangePartitioning window = new RangePartitioning ();
    ...
    public void initialize() {
        ...
        JButton btnNewButton = new JButton("Range Partitioning");
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    while (rs.next()) {
                        ...
                        if (rs.getInt(1)>=0 && rs.getInt(1) <= 11) {
                            ...
                            s.execute();
                        } else if (rs.getInt(1)>=10 && rs.getInt(1) <= 21) {
                            ...
                            s.setInt(5, rs.getInt(5));
                            s.execute();
                        } else if (rs.getInt(1)>=20 && rs.getInt(1) <= 31) {
